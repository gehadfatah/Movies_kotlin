...
interface MovieItemClickListener {
    fun movieItemClickListener(pos: Int, movie: com.goda.entities.MovieEntity, imageView: ImageView)
}
...
class ViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun bind(movie: com.goda.entities.MovieEntity, pos: Int, movieItemClickListener: MovieItemClickListener) {
        Picasso.get()
            .load(com.goda.domain.getImageURL(movie.poster_path))
...
class MoviesAdapter(
    ...
    private val moviesList: MutableLiveData<List<com.goda.entities.MovieEntity>>,
